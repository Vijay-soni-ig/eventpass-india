...
export default function Stalls() {
  ...
  const layoutExhibitionName =
    exhibitions.find((e) => e.id === layoutExhibitionId)?.name ?? "Select an exhibition";
    ...
    <div className="space-y-6 animate-slide-up">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Manage stall inventory and bookings</p>
        </div>
        <div className="flex gap-3">
          ...
          <Button asChild disabled={!layoutExhibitionId}>
            <Link to={layoutExhibitionId ? `/exhibitor-dashboard/stalls/editor/${layoutExhibitionId}` : "#"}>
