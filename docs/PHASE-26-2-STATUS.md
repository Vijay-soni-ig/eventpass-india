...
**CI: FINAL VERIFICATION REQUIRED on the rebased Phase 26.2 branch.**
...
Phase 26.2 can be marked PASS only after the rebased CI run succeeds and deployment-environment smoke checks are verified.
