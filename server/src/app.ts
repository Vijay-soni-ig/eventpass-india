...
import eventParticipantMediaRouter, { publicParticipantMediaRouter } from "./routes/eventParticipantMedia";
...
app.use("/api/public", publicParticipantMediaRouter); app.use("/api/pricing", pricingRouter);
