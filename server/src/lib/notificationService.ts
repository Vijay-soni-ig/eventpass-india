...
// Phase 31 (FP-06) added NotificationType.STALL_RESERVATION_EXPIRED for the
// notification dispatcher's IN_APP channel — it has no follower-engagement
// meaning (no organizer to follow, no NotificationPreference field) and is
// never generated by this file. Narrowed here rather than widening
// PREFERENCE_FIELD to Partial<Record<...>>, so every function in this file
// keeps a compile-time guarantee it only ever handles the five types it
// actually knows about.
type FollowerNotificationType = Exclude<NotificationType, "STALL_RESERVATION_EXPIRED">;
