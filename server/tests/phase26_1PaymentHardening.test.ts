...
test("Phase 26.1: Razorpay refund event exposes refund identity and amount", () => {
  withEnv({ RAZORPAY_KEY_ID: "rzp_test_example", RAZORPAY_KEY_SECRET: "key_secret_example", RAZORPAY_WEBHOOK_SECRET: "webhook_secret_example" }, () => {
    const provider = new RazorpayProvider();
...
test("Phase 26.1: mock provider rejects invalid money inputs and uses timing-safe signatures", async () => {
